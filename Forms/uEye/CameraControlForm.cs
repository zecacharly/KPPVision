...
namespace VisionModule {
    internal partial class CameraControlForm : Form {
        ...
        public CameraControlForm(uEye.Camera Camera):this() {
            m_Camera=Camera;
        }
        ...
        private void UpdateExposure() {
            ...
            if (!checkBoxFineIncrement.Checked) {
                ...
                statusRet = m_Camera.Timing.Exposure.FineIncrement.GetRange(out range);
            }
        ...
        private void checkBoxFramerateAuto_CheckedChanged(object sender, EventArgs e) {
            ...
            m_Camera.AutoFeatures.Software.SetEnableAutoFramerate(checkBoxFramerateAuto.Checked);
        }
        ...
        private void checkBoxExposureAuto_CheckedChanged(object sender, EventArgs e) {
            ...
            m_Camera.AutoFeatures.Software.SetEnableAutoShutter(checkBoxExposureAuto.Checked);
        }
        ...
        private void CameraControlForm_VisibleChanged(object sender, EventArgs e) {
            if (this.Visible) {
                UpdatePixelclock();
                UpdateFramerate();
                UpdateExposure();
                ...
                // check supported
                checkBoxFineIncrement.Enabled = m_Camera.Timing.Exposure.FineIncrement.Supported;

                // check enabled
                Boolean isEnabled;
                m_Camera.AutoFeatures.Software.GetEnableAutoShutter(out isEnabled);
                checkBoxExposureAuto.Checked = isEnabled;

                checkBoxFramerateAuto.Enabled = checkBoxExposureAuto.Checked;
                if (checkBoxExposureAuto.Checked) {
                    m_Camera.AutoFeatures.Software.GetEnableAutoFramerate(out isEnabled);
